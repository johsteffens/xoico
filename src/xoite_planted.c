...
"{"
    ...
    "feature aware xoite : finalize;"
    "feature aware xoite : expand_forward;"
    "feature aware xoite : expand_indef_typedef;"
    "feature aware xoite : expand_spect_declaration;"
    "feature aware xoite : expand_spect_definition;"
    "feature aware xoite : expand_declaration;"
    "feature aware xoite : expand_indef_declaration;"
    "feature aware xoite : expand_definition;"
    "feature aware xoite : expand_init1;"
"}";
...
BCORE_DEFINE_OBJECT_INST_P( xoite_builder_target_adl_s )
"aware bcore_array"
"{"
    "xoite_builder_target_s => [];"
"}";

BCORE_DEFINE_SPECT( xoite, xoite_builder )
"{"
    "bcore_spect_header_s header;"
    "feature aware xoite_builder : build;"
"}";
...
vd_t xoite_planted_signal_handler( const bcore_signal_s* o )
{
    switch( bcore_signal_s_handle_type( o, typeof( "xoite_planted" ) ) )
    {
        case TYPEOF_init1:
        {
            ...
            // group: xoite_builder
            BCORE_REGISTER_FEATURE( xoite_builder_build );
            BCORE_REGISTER_FFUNC( bcore_via_call_source, xoite_builder_target_s_source );
            BCORE_REGISTER_FFUNC( xoite_builder_build, xoite_builder_target_s_build );
            BCORE_REGISTER_OBJECT( xoite_builder_target_s );
            BCORE_REGISTER_OBJECT( xoite_builder_target_adl_s );
            BCORE_REGISTER_SPECT( xoite_builder );
        }
        break;
...
// BETH_PLANT_SIGNATURE 3992490947
